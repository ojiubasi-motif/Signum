...
exports.LID_TO_PHONE_CACHE = void 0;
...
exports.LID_TO_PHONE_CACHE = new Map();
function formatWhatsappNumber(jid) {
    ...
    if (exports.LID_TO_PHONE_CACHE.has(cleanNumber)) {
        cleanNumber = exports.LID_TO_PHONE_CACHE.get(cleanNumber);
